...
const FALLBACK = "https://images.unsplash.com/photo-1501281668745-f7f57925c3b4?w=600&q=80";

const events: {
  title: string; category: Category; date: string; month: Month;
  time: string; venue: string; description: string; image: string;
  link: string; highlight?: boolean;
}[] = [
  {
    title: "TomorrowLabs — Science Festival",
    category: "Science", date: "6 June 2026", month: "June",
    time: "4:00 PM – 10:00 PM", venue: "Wissenschaftshafen Magdeburg",
    ...
    link: "https://www.mpg.de/events/43771/2183", highlight: true,
  },
  {
    title: "Prinzessinnentag 2026",
    category: "Family", date: "26 June 2026", month: "June",
    time: "10:00 AM – 6:00 PM", venue: "Elbauenpark Magdeburg",
  ...
  },
  {
    ...
    category: "Festival", date: "2 July 2026", month: "July",
    time: "12:00 PM – Late", venue: "Elbauenpark Magdeburg",
    ...
    link: "https://www.mvgm.de/de/events/", highlight: true,
  },
  {
    title: "Holi Festival of Colours",
    category: "Festival", date: "7 July 2026", month: "July",
    time: "2:00 PM – 9:00 PM", venue: "Elbauenpark Magdeburg",
  ...
  },
  {
    ...
    category: "Culture", date: "11 July 2026", month: "July",
    time: "8:00 PM", venue: "Seebühne Magdeburg",
  ...
  },
  {
    ...
    category: "Sport", date: "4 July 2026", month: "July",
    time: "9:00 AM – 5:00 PM", venue: "Elbauenpark Magdeburg",
  ...
  },
  {
    ...
    category: "Festival", date: "15 August 2026", month: "August",
    time: "9:00 PM – 11:30 PM", venue: "Elbauenpark Magdeburg",
  ...
  },
  {
    ...
    category: "Music", date: "11 August 2026", month: "August",
    time: "3:00 PM – Late", venue: "Elbauenpark Magdeburg",
  ...
  },
  {
    ...
    category: "Culture", date: "21 August 2026", month: "August",
    time: "7:30 PM", venue: "Seebühne Magdeburg",
  ...
  },
  {
    ...
    category: "Music", date: "16–20 September 2026", month: "September",
    time: "All Day", venue: "Stadtmitte Magdeburg",
    ...
    link: "https://www.interkultur.com/events/2026/magdeburg", highlight: true,
  },
  {
    title: "Company Contact Fair 2026",
    category: "Science", date: "21 October 2026", month: "October",
    time: "10:00 AM – 5:00 PM", venue: "Otto-von-Guericke-Universität",
  ...
  },
  {
    ...
    category: "Culture", date: "22 May – 11 Sep 2026", month: "June",
    time: "7:00 PM", venue: "Elbe Riverbank, Magdeburg",
...
/** Wrapper: shows next.js Image but falls back to <img> on error */
function EventImage({ src, alt }: { src: string; alt: string }) {
  const [errored, setErrored] = useState(false);
  if (errored) {
    return (
      // eslint-disable-next-line @next/next/no-img-element
      <img src={FALLBACK} alt={alt} className="absolute inset-0 h-full w-full object-cover" />
    );
  }
  return (
    <Image
            ...
            {highlights.map((e) => {
              ...
              return (
                <a key={e.title} href={e.link} target="_blank" rel="noopener noreferrer"
                  className="group relative rounded-[24px] overflow-hidden border border-slate-200 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 block h-52">
